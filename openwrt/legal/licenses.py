...
packages = [
   ...
   , Package( "linux-ar71xx_generic"
    ...
    , Package( "linux-atm"
            ...
            , [License("specific", "COPYING"), License("GPL-2", "COPYING.GPL"), License("LGPL-2.1", "COPYING.LGPL")]
            , True 
            , None ) 
    , Package( "mtd"
            , None
   ...
   , Package( "toolchain"
            ...
            , "<website>"
            , "toolchain"
            , [License("LPGL-2.1", "../toolchain-mips_34kc_gcc-4.8-linaro_uClibc-0.9.33.2/uClibc-0.9.33.2/COPYING.LIB")]
            , False 
            , "see subpackages" ) 
    , Package( "libc"
            , "0.9.33.2"
    ...
    , Package( "libgcc"
            ...
            , ""
            , [License("LPGL-2.1", "../toolchain-mips_34kc_gcc-4.8-linaro_uClibc-0.9.33.2/gcc-linaro-4.8-2014.01/COPYING.LIB")]
            , True 
            , None ) 
    , Package( "libpthread"
            , "0.9.33.2"
    ...
    , Package( "librt"
            , "0.9.33.2"
            , "http://freecode.com/projects/librt"
            , ""
            , [License("LPGL-2.1", "../toolchain-mips_34kc_gcc-4.8-linaro_uClibc-0.9.33.2/gcc-linaro-4.8-2014.01/COPYING.LIB")]
            , True 
            , None ) 
