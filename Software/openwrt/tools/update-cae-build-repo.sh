...
OPENWRT_DIR=Software/openwrt
SRC_OPENWRT_DIR=${SRC_DIR}/${OPENWRT_DIR}
DEST_OPENWRT_DIR=${DEST_DIR}/${OPENWRT_DIR}
DEST_IPBRIDGE_MOCK_MAKEFILE=${DEST_DIR}/Software/bridge/build/Makefile
...
svnRelativeUrlToGitBranchName() {
	...
	local SMARTBRIDGE_PATH=`echo ${RELATIVE_URL} | sed 's#\^/Products/SmartBridge/##g'`
